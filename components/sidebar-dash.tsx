...
const Sidebar = ({
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-40 flex h-screen lg:w-60 flex-col overflow-y-hidden bg-popover duration-150 ease-in-out border-r  lg:static lg:translate-x-0 ${
